...
class Search extends Component {
  render() {
    ...
    return (
      <div className="search" style={menu.className === 'fixed' ? style : null} lang="ru">
        <div className="container">
          ...
          <p className="search__text">Из диаграммы можно сделать вывод, что максимальный рост поисковой выдачи составляет 5 163% (количество страниц по запросу «Пасльон Володимир Володимирович, ДонНТУ» выросло с 90 000 до 5 млн), а для некоторых запросов количество найденных страниц не изменилось, а для некоторых страниц количество результатов поиска значительно сократилось. Максимальное уменьшение количества результатов поиска составляет 96%. Данный показатель наблюдается в поисковой системе «Bing» для запроса «Системы мониторинга промышленных предприятий» (количество результатов уменьшилось с 239 000 до 9060).</p>
          <p className="search__text">Диаграмма также позволяет оценить изменения для каждого выполненного запроса.</p>
          <p className="search__text">Так, например, количество найденных страниц в поисковой системе Google для запроса «Системы мониторинга промышленных предприятий» выросло на 144% (с 414 000 до 1 010 000), а поисковая выдача по запросу «Исследование модели стабилизации беспилотных летательных аппаратов» в системе Bing упала на 67% (с 3470 до 1150). При этом данные большого числа страниц совсем не изменилось или изменились очень незначительно.</p>
        </div>
      </div>
    );
  }
