...
import image1 from '../../img/article/article1.png';
...
class DocumentPreview extends Component {
  ...
  render() {
    const { closeDocument } = this;

    const buttonStyle = {
      right: (document.documentElement.clientWidth - 1190 * 0.5) / 2 - 35
    }
    ...
    return (
      <div className="document-preview">
        <button onClick={closeDocument} style={buttonStyle} />
        <div className="document-preview__document">
          <div className="page">
          ...
          <div className="page">
            ...
            <br />
            <p className="image-container"><img src={image1} className="image" /></p>
          ...
          <div className="page">
            <p className="paragraph">Таблица 1 – Зависимость частоты вращения двигателей от отклонения</p>
